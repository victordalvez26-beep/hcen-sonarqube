...
/**
 * DTO usado para recibir metadata desde el componente periférico.
 * 
 * Este DTO es compatible con el que usa el componente periférico
 * para enviar metadata al backend HCEN.
 */
