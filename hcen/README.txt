...
a persistence unit "hcenPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "hcen/pom.xml":
...
artifacts ("hcen-ejb.jar" and "hcen-web.war") are already built. You can build
